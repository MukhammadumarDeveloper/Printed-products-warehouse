package org.itpu.controller.io;
...
public class InputReader {
    ...
    public InputReader(BufferedReader in, Set<FinishStatus> stopStatuses, Action action) {
        this.in =in;
    ...
    public static class Builder {
        ...
        public Builder(IOHolder holder, InputStream in) {
            this.holder = holder;
            this.in = in;
            this.reader = null;
        }

        public Builder(IOHolder holder, BufferedReader reader) {
            this.holder = holder;
            this.in = null;
            this.reader = reader;
        }
